...
export const EditWallet = () => {
    ...
    return (
        <form onSubmit={handleSubmit(saveRate)} className="flex gap-4 items-center">
            <input type="number" {...register('rate', {required: true, value: 50})} disabled={!editing} className="border border-3 rounded-xl px-4 py-2 text-right w-[150px] outline-accent" />
