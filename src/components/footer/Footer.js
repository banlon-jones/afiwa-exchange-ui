...
const Footer = () => {
    return (
        <footer className={'flex text-[20px] flex-col text-secondary-2 border-t-2 pt-4'}>
            <div className="w-[75vw] mx-auto border-b-2 py-6 flex gap-[200px] [&>.section]:flex [&>.section]:flex-col [&>.section>.section-name]:text-black [&>.section>.section-name]:uppercase [&>.section>.section-name]:font-bold [&>.section>.section-name]:mb-2 [&>.section>.link]:py-1">
                <div>
                    <Link className="py-6 block"><img src={logo} /></Link>
